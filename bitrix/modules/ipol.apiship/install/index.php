...
Class ipol_apiship extends CModule{
	...
	function InstallEvents(){
		//события устанавливаются в файле /classes/general/apishiphelper.php функция auth
		return true;
	}
	function UnInstallEvents() {
		UnRegisterModuleDependences("main", "OnEpilog", $this->MODULE_ID, "apishipdriver", "onEpilog"); // заполнение заявки		
		UnRegisterModuleDependences("main", "OnEndBufferContent", $this->MODULE_ID, "CDeliveryapiship", "onBufferContent"); // сохранение города и пункта при перезагрузке
		...
		UnRegisterModuleDependences("main", "OnAdminListDisplay", $this->MODULE_ID, "apishipdriver", "displayActPrint"); // печати
		UnRegisterModuleDependences("main", "OnBeforeProlog", $this->MODULE_ID, "apishipdriver", "OnBeforePrologHandler");
		UnRegisterModuleDependences("sale", "OnSaleComponentOrderOneStepComplete", $this->MODULE_ID, "apishipdriver", "orderCreate"); // создание заказа
